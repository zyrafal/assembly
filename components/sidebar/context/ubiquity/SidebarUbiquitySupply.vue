...
export default defineComponent({
  ...
  setup(props) {
    ...
    const { tokenKey, token, debt, collateral, liquidation, liquidationMaxPrice, isNewSafe, safeId, safeType, fetchPosition } = useUbiquityPosition()
    ...
    const { liquidationPrice, status } = useUbiquityPosition(changedCollateral, debt)
